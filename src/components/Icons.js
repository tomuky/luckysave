...
export function TrophyIcon({ size = 20, className }) {
  return (
    ...
    >
      <path
        d="M6 3h8v6a4 4 0 11-8 0V3z"
        stroke="currentColor"
        strokeWidth="1.5"
      />
      <path
        d="M6 5H3a1 1 0 00-1 1v1a3 3 0 003 3M14 5h3a1 1 0 011 1v1a3 3 0 01-3 3M10 13v3M7 17h6"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
export function TicketIcon({ size = 20, className }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        d="M2 7a2 2 0 012-2h12a2 2 0 012 2v1a2 2 0 100 4v1a2 2 0 01-2 2H4a2 2 0 01-2-2v-1a2 2 0 100-4V7z"
        stroke="currentColor"
        strokeWidth="1.5"
      />
      <path
...
export function CoinsIcon({ size = 20, className }) {
  return (
    <svg
      width={size}
      height={size}
